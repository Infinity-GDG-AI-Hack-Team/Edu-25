        ...
        <div className="md:col-span-1">
          ...
          <div className="mt-8 p-4 border rounded-lg">
            ...
            <div className="space-y-4">
              {[
                { name: "Alex Rivera", questions: 23, badge: "Platinum" },
                { name: "Sarah Johnson", questions: 15, badge: "Gold" },
                { name: "Mike Chen", questions: 8, badge: "Silver" },
                { name: "Jordan Taylor", questions: 5, badge: "Bronze" },
              ].map((user, index) => (
